...
namespace YayCurrencyScoped\YayCommerce\AdminShell\Support;
...
class AdminContext
{
    ...
    {
        return \function_exists('YayCurrencyScoped\\is_network_admin') && \YayCurrencyScoped\is_network_admin();
    }
    /**
