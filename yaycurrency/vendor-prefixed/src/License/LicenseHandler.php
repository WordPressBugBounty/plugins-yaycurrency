...
namespace YayCurrencyScoped\YayCommerce\AdminShell\License;

use YayCurrencyScoped\YayCommerce\AdminShell\License\Contracts\LicenseConfigAdapter;
use YayCurrencyScoped\YayCommerce\AdminShell\Support\Slug;
...
class LicenseHandler
{
    ...
    public static function remove_site_plugin_check(LicenseConfigAdapter $adapter) : void
    {
        ...
        if (!\function_exists('YayCurrencyScoped\\get_plugin_data')) {
