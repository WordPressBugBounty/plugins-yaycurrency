...
namespace YayCurrencyScoped\YayCommerce\AdminShell\Registry;
...
class LicenseRegistry
{
    ...
    public function all() : array
    {
        ...
        $old_plugins = [];
        $handlers = ['YayCurrencyScoped\\YAYDP\\License\\License_Handler', 'YayCurrencyScoped\\YayMail\\License\\LicenseHandler', 'YayCurrencyScoped\\Yay_Currency\\License\\LicenseHandler', 'YayCurrencyScoped\\Yay_Swatches\\License\\LicenseHandler', 'YayCurrencyScoped\\YayExtra\\License\\LicenseHandler', 'YayCurrencyScoped\\YayRev\\License\\LicenseHandler', 'YayCurrencyScoped\\YayWholesaleB2B\\License\\LicenseHandler', 'YayCurrencyScoped\\YaySMTP\\License\\LicenseHandler'];
